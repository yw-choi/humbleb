...
16. ✅ 경기결과 입력 UI (스코어 +/- 버튼, 56x56px 터치)
17. ✅ 시간 기반 화면 전환 (정모 ±1시간, 참가자에게만)
18. ✅ 결과 기반 내부 레이팅 업데이트 (ELO K=16)

### Phase 5: 폴리시 ✅

19. ✅ 모바일 최적화 (기존 코드 이미 준수 — dvh, 16px, 48px)
20. ✅ 대진표 이미지 다운로드 (Pillow PNG, 카톡 공유용)
21. ✅ 과거 정모 히스토리 조회 (/history)
22. ✅ 멤버별 통계 (/stats — 승률, 게임 수, ELO 레이팅)
